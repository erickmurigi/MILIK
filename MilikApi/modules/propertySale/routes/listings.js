...
import { bulkImportListings } from "../controllers/bulkImportController.js";
...
router.post("/bulk", requireCompanyPermission("sale-listings", "create", "propertySale"), bulkImportListings);
