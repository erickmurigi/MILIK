        ...
        <div className="flex shrink-0 flex-wrap items-center gap-x-3 gap-y-1 border-b border-slate-200 bg-[#EDF5F1] px-3 py-1.5">
          ...
          <div className="ml-auto flex items-center gap-1.5">
            ...
            <button
              ...
              className="inline-flex h-7 items-center gap-1.5 bg-[#FF8C00] px-2.5 text-[10px] font-bold text-white hover:bg-[#E67E00]"
            >
          ...
          <table className="w-full min-w-[750px] text-xs">
            <thead className="sticky top-0 z-10 bg-[#0B3B2E] text-white">
              <tr>
                ...
                <th className="px-3 py-2 text-right text-[10px] font-extrabold uppercase tracking-widest">Reorder Level</th>
                <th className="px-3 py-2 text-right text-[10px] font-extrabold uppercase tracking-widest">Deficit</th>
