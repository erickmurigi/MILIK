  ...
  <DashboardLayout>
    <div className="min-h-[calc(100vh-8rem)] bg-[#F4F7F5] p-2 text-slate-900">
      <div
        ...
        style={{ borderLeftWidth: 3, borderLeftColor: "#1a5c3a" }}
      >
        <div className="flex items-baseline gap-2">
          <FaWarehouse className="text-[#1a5c3a] text-xs shrink-0" />
          <span className="text-[11px] font-bold uppercase tracking-[0.16em] text-[#1a5c3a]">Inventory & POS</span>
