...
const QUICK_NAV = [
  ...
  { label: "Budget Plans",        icon: FaChartPie,   route: "/accounts/budget",                    color: "#0f766e", desc: "Create & manage budget periods" },
  { label: "Budget vs Actual",   icon: FaChartPie,   route: "/accounts/budget/analysis",           color: "#0f766e", desc: "Compare budgeted vs actual GL spend" },
