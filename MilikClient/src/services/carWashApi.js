...
export const carWashApi = {
  ...
  listLoyaltyCustomers: async (params = {}) => (await adminRequests.get("/carwash/loyalty/customers", { params }))?.data,
  awardManualStamp: async (customerId, payload) => unwrap(await adminRequests.post(`/carwash/loyalty/customers/${customerId}/stamp`, payload)),
  ...
  backfillCustomerStats: async () => unwrap(await adminRequests.post("/carwash/loyalty/admin/backfill-stats")),
  ...
  bulkSendCustomerSms: async (payload) => unwrap(await adminRequests.post('/carwash/loyalty/customers/bulk-sms', payload)),
  findDuplicateCustomers: async () => unwrap(await adminRequests.get('/carwash/loyalty/customers/duplicates')),
  mergeCustomers: async (payload) => unwrap(await adminRequests.post('/carwash/loyalty/customers/merge', payload)),
  exportCustomersCsv: async (params = {}) => adminRequests.get('/carwash/loyalty/customers/enriched', { params: { ...params, export: 'csv' }, responseType: 'blob' }),
  ...
  listCustomerCredits: async (params = {}) => (await adminRequests.get('/carwash/credits', { params }))?.data,
