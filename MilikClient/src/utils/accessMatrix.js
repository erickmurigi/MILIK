...
export const LEGACY_PERMISSION_ALIASES = {
  ...
  statements:        { view: ['view_statements'], create: ['create_statement'], approve: ['approve_statement'], reverse: ['reverse_statement'], export: ['view_statements'] },
  ...
  processedStatements: { view: ['view_processed_statements'] },
  ...
  maintenances:      { view: ['view_maintenance'], create: ['create_maintenance'], update: ['update_maintenance'], close: ['close_maintenance'] },
  inspections:       { view: ['view_inspections'], create: ['create_inspection'], update: ['update_inspection'], close: ['close_inspection'] },
