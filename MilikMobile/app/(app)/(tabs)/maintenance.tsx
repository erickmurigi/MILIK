  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.chips}>
        {['All', 'Open', 'In Progress', 'Resolved'].map((chip, i) => (
          <TouchableOpacity
            key={chip}
      ...
      <View style={styles.empty}>
        <Ionicons name="construct-outline" size={56} color={Colors.border} />
        <Text style={styles.emptyTitle}>No maintenance requests</Text>
        <Text style={styles.emptySub}>Log a request using the + button above</Text>
      </View>
    </SafeAreaView>
  );
}
